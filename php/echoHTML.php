	...
	<div class="top-nav group">
        <section>
            ...
            <ul class="top-nav-quicklink flexContain">
                ...
                <li><a href="doitrahang.php"><i class="fa fa-phone"></i> Đổi trả hàng</a></li>
            </ul> <!-- End Quick link -->
        </section><!-- End Section -->
    </div><!-- End Top Nav  -->';
}
...
function addHeader()
{
	...
	<div class="header group">
        ...
        <div class="logo">
            <a href="index.php">
                <img src="img/1.jpg" alt="Trang chủ" title="Trang chủ">
            </a>
        </div> <!-- End Logo -->
    ...
    <div class="plc">
        <section>
            <ul class="flexContain">
                ...
                <li>Trải nghiệm sản phẩm mới tại siêu thị</li>
                <li>Đổi trả hàng trong 7 ngày nếu sản phẩm lỗi</li>
                <li>Hỗ trợ 24/24.
                    <br>Hotline:
