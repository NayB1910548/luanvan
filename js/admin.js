...
function addThongKe() {
    var dataChart = {
        type: 'bar',
        data: {
            labels: ["Thịt", "Cá", "Kem", "Mì", "Nước giải khát", "Nước giặt", "Rau củ quả", "Sữa"],
            datasets: [{
...
function showGTKM() {
    ...
    switch (giaTri) {
        ...
        case '2':
                document.getElementById("giatrikm").value = 20000;
            break;

        case '3':
                document.getElementById("giatrikm").value = 30000;
            break;
        ...
        <table class="overlayTable table-outline table-content table-header">
            ...
            <tr>
                ...
                <td>
                    ...
                    var company = ["Thịt", "Cá", "Kem", "Mì", "Nước giải khát", "Nước giặt", "Rau củ quả", "Sữa"];
                    var i = 1;
            ...
            <tr>
                ...
                <td><input id="giatrikm" type="text" value="1"></td>
            </tr>
            <tr>
            ...
            <tr>
                <td>Màn hình:</td>
                <td><input type="text" value="` + sp.Xuatsu + `"></td>
            </tr>
            <tr>
                <td>Màn hình:</td>
